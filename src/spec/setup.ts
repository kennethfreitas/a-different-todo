...
import { ExpiredTaskAlert } from '@core/task/integrations/ExpiredTaskAlert';
...
import { AlertExpirationMock, NotifyTaskMock, TaskRepositoryMock, UserRepositoryMock } from './mocks';
...
Container.set(ExpiredTaskAlert, AlertExpirationMock);
